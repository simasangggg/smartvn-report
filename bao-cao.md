...
![Sơ đồ trạng thái Circuit Breaker](diagrams/circuit-breaker.png)
...
: Các endpoint của Product Service 
...
: Các endpoint của Order Service 
...
: Các endpoint của Admin Service 
...
![Sơ đồ kiến trúc Microservices SmartVN](diagrams/architecture.png)

Hệ thống SmartVN được thiết kế theo kiến trúc Microservices với nhiều tầng (layer) phân tách rõ ràng.

![Sơ đồ kiến trúc tổng thể hệ thống SmartVN](images/kien-truc-tong-the.png)
...
![Sơ đồ ERD hệ thống SmartVN](diagrams/erd.png)
...
: Cấu trúc bảng user_interaction 
...
![Sơ đồ trạng thái đơn hàng](images/order-lifecycle.png)
...
: Danh sách các Docker container 
...
![Giao diện đăng ký tài khoản](images/demo-register.png)
...
![Giao diện danh sách sản phẩm](images/demo-products.png)
...
![Giao diện giỏ hàng](images/demo-cart.png)
...
![Giao diện thanh toán VNPay](images/demo-vnpay.png)
...
![Giao diện Admin Dashboard](images/demo-dashboard.png)
...
![Sơ đồ Use Case tổng quan ứng dụng Mobile — Phía người dùng](images/mobile-use-case-user.png)
...
![Biểu đồ trình tự đăng nhập](diagrams/seq-login.png)
...
![Biểu đồ trình tự — Đăng ký tài khoản](images/mobile-seq-register.png)
...
![Biểu đồ trình tự — Xem danh sách sản phẩm](images/mobile-seq-products.png)
...
![Biểu đồ trình tự đặt hàng](diagrams/seq-order.png)
...
![Biểu đồ trình tự — Quản lý giỏ hàng](images/mobile-seq-cart.png)
...
![Biểu đồ trình tự — Đồng bộ giỏ hàng với server](images/mobile-seq-sync.png)
...
![Thiết kế giao diện Trang chủ](images/mobile-ui-home.png)
...
![Thiết kế giao diện Chi tiết sản phẩm](images/mobile-ui-product-detail.png)
...
![Thiết kế giao diện Giỏ hàng](images/mobile-ui-cart.png)
...
![Thiết kế giao diện Đăng nhập](images/mobile-ui-login.png)
...
![Thiết kế giao diện Checkout](images/mobile-ui-checkout.png)
...
![Thiết kế giao diện Danh sách đơn hàng](images/mobile-ui-orders.png)
...
![Thiết kế giao diện Tài khoản](images/mobile-ui-profile.png)
...
![Mô hình ERD cơ sở dữ liệu cục bộ trên Android](images/mobile-erd-local.png)

## 7.5 Thiết kế kiến trúc tổng thể mobile

### 7.5.1 Sơ đồ kiến trúc ứng dụng

![Sơ đồ kiến trúc MVVM](diagrams/mvvm.png)

### 7.5.2 Luồng dữ liệu tổng thể

![Luồng dữ liệu trong ứng dụng Mobile](images/mobile-data-flow.png)
...
![Giao diện trang Đăng ký](images/mobile-screen-register.png)
...
![Giao diện trang Đăng nhập](images/mobile-screen-login.png)
...
![Giao diện Trang chủ](images/mobile-screen-home.png)
...
![Giao diện Chi tiết sản phẩm](images/mobile-screen-product-detail.png)
...
![Giao diện Tìm kiếm sản phẩm](images/mobile-screen-search.png)
...
![Giao diện Giỏ hàng](images/mobile-screen-cart.png)
...
![Giao diện Checkout](images/mobile-screen-checkout.png)
...
![Giao diện Thanh toán VNPay](images/mobile-screen-vnpay.png)
...
![Giao diện Đặt hàng thành công](images/mobile-screen-order-success.png)
...
![Giao diện Danh sách đơn hàng](images/mobile-screen-orders.png)
...
![Giao diện Chi tiết đơn hàng](images/mobile-screen-order-detail.png)
...
![Giao diện Quản lý tài khoản](images/mobile-screen-profile.png)
...
: Test cases cho Product Service 
...
![Kết quả benchmark không sử dụng cache](images/benchmark-no-cache.png)

**Kết quả With Redis Cache:**

![Kết quả benchmark với Redis cache](images/benchmark-with-cache.png)

...
Như thể hiện trong Bảng, kiến trúc Microservices có ưu điểm vượt trội về khả năng mở rộng và triển khai, tuy nhiên đòi hỏi độ phức tạp cao hơn trong giai đoạn phát triển ban đầu.
...
![Hình 1: Luồng xử lý Redis Cache](diagrams/redis-cache.png)

### Chiến lược TTL

TTL (Time To Live) là thời gian sống của dữ liệu trong cache. Sau khi hết TTL, dữ liệu sẽ bị xóa tự động.

: Bảng 2: Cấu hình TTL cho các cache trong hệ thống
...
![Hình 2: Sơ đồ trạng thái Circuit Breaker](diagrams/circuit-breaker.png)
...
: Bảng 3: Các endpoint của User Service
...
: Bảng 4: Các endpoint của Product Service
...
: Bảng 5: Các endpoint của Order Service
...
: Bảng 6: Các endpoint của Admin Service
...
: Bảng 7: Yêu cầu phi chức năng của hệ thống
...
![Hình 3: Sơ đồ kiến trúc Microservices SmartVN](diagrams/architecture.png)

Hệ thống SmartVN được thiết kế theo kiến trúc Microservices với nhiều tầng (layer) phân tách rõ ràng.

![Hình 4: Sơ đồ kiến trúc tổng thể hệ thống SmartVN](images/kien-truc-tong-the.png)

Như thể hiện trong Hình, hệ thống bao gồm các tầng chính:
...
![Hình 5: Sơ đồ ERD hệ thống SmartVN](diagrams/erd.png)

### Chi tiết các bảng

**Bảng user:**

: Bảng 9: Cấu trúc bảng user
...
: Bảng 11: Cấu trúc bảng category
...
: Bảng 12: Cấu trúc bảng inventory
...
: Bảng 14: Cấu trúc bảng order_item
...
: Bảng 15: Cấu trúc bảng payment_detail
...
: Bảng 16: Cấu trúc bảng user_interaction
...
![Hình 6: Sơ đồ trạng thái đơn hàng](images/order-lifecycle.png)
...
: Bảng 17: Chiến lược cache eviction
...
: Bảng 18: Danh sách các Docker container
...
![Hình 7: Giao diện đăng ký tài khoản](images/demo-register.png)
...
![Hình 8: Giao diện danh sách sản phẩm](images/demo-products.png)
...
![Hình 9: Giao diện giỏ hàng](images/demo-cart.png)
...
![Hình 10: Giao diện thanh toán VNPay](images/demo-vnpay.png)
...
![Hình 11: Giao diện Admin Dashboard](images/demo-dashboard.png)
...
![Hình 12: Sơ đồ Use Case tổng quan ứng dụng Mobile — Phía người dùng](images/mobile-use-case-user.png)

Như thể hiện trong Hình, ứng dụng mobile SmartVN hỗ trợ các tác nhân chính:
...
![Hình 13: Biểu đồ trình tự đăng nhập](diagrams/seq-login.png)
...
![Hình 14: Biểu đồ trình tự — Đăng ký tài khoản](images/mobile-seq-register.png)
...
![Hình 15: Biểu đồ trình tự — Xem danh sách sản phẩm](images/mobile-seq-products.png)
...
![Hình 16: Biểu đồ trình tự đặt hàng](diagrams/seq-order.png)
...
![Hình 17: Biểu đồ trình tự — Quản lý giỏ hàng](images/mobile-seq-cart.png)
...
![Hình 18: Biểu đồ trình tự — Đồng bộ giỏ hàng với server](images/mobile-seq-sync.png)
...
![Hình 19: Thiết kế giao diện Trang chủ](images/mobile-ui-home.png)
...
![Hình 20: Thiết kế giao diện Chi tiết sản phẩm](images/mobile-ui-product-detail.png)
...
![Hình 21: Thiết kế giao diện Giỏ hàng](images/mobile-ui-cart.png)
...
![Hình 22: Thiết kế giao diện Đăng nhập](images/mobile-ui-login.png)
...
![Hình 23: Thiết kế giao diện Checkout](images/mobile-ui-checkout.png)
...
![Hình 24: Thiết kế giao diện Danh sách đơn hàng](images/mobile-ui-orders.png)
...
![Hình 25: Thiết kế giao diện Tài khoản](images/mobile-ui-profile.png)
...
![Hình 26: Mô hình ERD cơ sở dữ liệu cục bộ trên Android](images/mobile-erd-local.png)

## 7.5 Thiết kế kiến trúc tổng thể mobile

### 7.5.1 Sơ đồ kiến trúc ứng dụng

![Hình 27: Sơ đồ kiến trúc MVVM](diagrams/mvvm.png)

### 7.5.2 Luồng dữ liệu tổng thể

![Hình 28: Luồng dữ liệu trong ứng dụng Mobile](images/mobile-data-flow.png)
...
![Hình 29: Giao diện trang Đăng ký](images/mobile-screen-register.png)
...
![Hình 30: Giao diện trang Đăng nhập](images/mobile-screen-login.png)
...
![Hình 31: Giao diện Trang chủ](images/mobile-screen-home.png)
...
![Hình 32: Giao diện Chi tiết sản phẩm](images/mobile-screen-product-detail.png)
...
![Hình 33: Giao diện Tìm kiếm sản phẩm](images/mobile-screen-search.png)
...
![Hình 34: Giao diện Giỏ hàng](images/mobile-screen-cart.png)
...
![Hình 35: Giao diện Checkout](images/mobile-screen-checkout.png)
...
![Hình 36: Giao diện Thanh toán VNPay](images/mobile-screen-vnpay.png)
...
![Hình 37: Giao diện Đặt hàng thành công](images/mobile-screen-order-success.png)
...
![Hình 38: Giao diện Danh sách đơn hàng](images/mobile-screen-orders.png)
...
![Hình 39: Giao diện Chi tiết đơn hàng](images/mobile-screen-order-detail.png)
...
![Hình 40: Giao diện Quản lý tài khoản](images/mobile-screen-profile.png)
...
: Bảng 19: Test cases cho User Service
...
: Bảng 20: Test cases cho Product Service
...
: Bảng 21: Test cases cho Order Service
...
: Bảng 22: Test cases cho Admin Service
...
![Hình 41: Kết quả benchmark không sử dụng cache](images/benchmark-no-cache.png)

**Kết quả With Redis Cache:**

![Hình 42: Kết quả benchmark với Redis cache](images/benchmark-with-cache.png)

### Phân tích: Response time, Throughput, Failure rate

**So sánh Response Time:**

: Bảng 23: So sánh thời gian phản hồi
...
Như thể hiện trong Bảng, Redis cache giúp giảm đáng kể thời gian phản hồi ở mọi percentile. Đặc biệt, percentile 95 giảm từ 172.88ms xuống 19.11ms — cải thiện gấp **9 lần**.

**So sánh Throughput:**

: Bảng 24: So sánh throughput
...
: Bảng 26: Bảng phân công công việc
...
: Bảng 27: Danh sách đầy đủ API endpoints
